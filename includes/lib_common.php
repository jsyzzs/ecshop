...
function load_config()
{
    ...
    if ($data === false)
    {
        ...
        /* 对数值型设置处理 */
        $arr['shop_jifen']			 = intval($arr['shop_jifen']);
...
function log_account_change_new($user_id, $user_money = 0, $frozen_money = 0, $rank_points = 0, $pay_points = 0, $change_desc = '', $change_type = ACT_OTHER)
{
	/* 插入帐户变动记录 */
	$account_log = array(
			'user_id'       => $user_id,
