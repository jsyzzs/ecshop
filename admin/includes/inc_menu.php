...
$modules['03_promotion']['17_wj_lottery']           = 'wj_lottery.php?act=list';       //抽奖列表
$modules['03_promotion']['18_wj_lottery_group']     = 'wj_lottery_group.php?act=list'; //抽奖级别
$modules['03_promotion']['19_wj_lottery_user']      = 'wj_lottery_user.php?act=list';  //获奖列表
