...
elseif ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit' || $_REQUEST['act'] == 'copy')
{
    ...
    /* 商品短标题 */
    $good_short_name = $goods['good_short_name'];
    /* 创建 html editor */
    ...
    $smarty->assign('good_short_name', $good_short_name);
...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    $goods_short_name = $_POST['good_short_name'];
    ...
    if ($is_insert)
    {
        if ($code == '')
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, good_short_name,goods_name_style, goods_sn, " .
                ...
                "VALUES ('$_POST[goods_name]','$goods_short_name', '$goods_name_style', '$goods_sn', '$catgory_id', " .
    ...
    else
    {
        ...
        $sql = "UPDATE " . $ecs->table('goods') . " SET " .
                ...
                "good_short_name = '$goods_short_name', " .
                "goods_sn = '$goods_sn', " .
                "cat_id = '$catgory_id', " .
                "brand_id = '$brand_id', " .
