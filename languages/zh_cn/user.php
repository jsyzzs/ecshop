...
$_LANG['surplus_appl_submit'] = '您的积分兑换成功！';
...
$_LANG['amount_gt_zero'] = '请在“金币”栏输入大于0的数字';
$_LANG['amount_gt_pay'] = '您的积分太少，无法排队。';
$_LANG['amount_gt_pay_ok'] = '您已经进入排队队列，恭喜您！';
$_LANG['amount_gt_pay_no'] = '您输入得数值不为积分兑换单位得整数倍，请验证！';
...
$_LANG['passport_js']['username_shorter'] = '- 手机号长度不能少于 11 个字符。';
