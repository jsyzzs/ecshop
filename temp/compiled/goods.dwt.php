...
<div class="blank"></div>
  <div class="AreaR" style="float:left" style="width:1225px">
   <div id="goodsInfo">
     ...
     <a href="<?php echo $this->_var['pictures']['0']['img_url']; ?>" id="zoom1" class="MagicZoom MagicThumb" title="<?php echo $this->_var['goods']['goods_style_name']; ?>">
      <img src="<?php echo $this->_var['goods']['original_img']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" width="420px;"  height="420px;"/>
     </a>
     </div>
     <div class="blank"></div>
   ...
   <a  href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>)"><img src="themes/quwan/images/shoucang1.gif" /></a>
    ...
    <div class="clearfix" style="font-size:18px;  border-bottom:1px  dashed #dedede;font-weight:bold; color:#666; padding:5px 0; line-height:30px;">
...
<li class="clearfix goods_box_li" style=" border:none">
    ...
    <?php if ($this->_var['goods']['give_integral'] > 0): ?>
        <dd >
            <strong><?php echo $this->_var['lang']['gb_gift_integral']; ?></strong><font class="f4" style=" color:#e35b00"><?php echo $this->_var['goods']['give_integral']; ?> <?php echo $this->_var['points_name']; ?></font> <a href="#">[什么是积分?]</a>
        </dd>
    <?php endif; ?>
...
?>
    ...
    <li class="padd loop"> 
     ...
     <li class="padd loop" style="height:42px;"> 
       <dd>
        <a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)"><img src="themes/quwan/images/bnt_cat.png" /></a>
        <a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)"><img src="themes/quwan/images/bnt_msg.png" /></a>
    </dd> 
     </li> 
    </ul>
   ...
   <div class="blank"></div> 
   <div style="padding:10px 0;width:1225px;">
...
<?php echo $this->fetch('library/bought_goods.lbi'); ?>
 ...
 <div>
	 <strong><?php echo $this->_var['lang']['goods_sn']; ?></strong><?php echo $this->_var['goods']['goods_id']; ?>
 </div>
...
<script type="text/javascript" id="bdshare_js" data="type=tools&amp;uid=3286259" ></script>
