...
if (!$smarty->is_cached('index.dwt', $cache_id))
{
    ...
    $smarty->assign('class_articles_10',    index_get_class_articles(10,10));   // 分类调用文章
    //调用多个就修改传进去的参数,以及模板接收的变量,其中上面的4就是文章分类ID,其中6是调用数量
	$smarty->assign('class_articles_11',    index_get_class_articles(11,10));   // 分类调用文章
...
//echo $slnum;
	...
	$user_card="9100001".$user_idn;

//echo $user_card;
//echo $_CFG['shop_jifen'];
